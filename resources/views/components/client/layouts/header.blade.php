<header>
            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        ...
                        <li @class([
                            'active-menu' => request()->routeIs(['home', 'home.*']),
                        ])>
                            <a href="{{ route('home') }}">Home</a>
                        </li>

                        <li @class([
                            'active-menu' => request()->routeIs(['products', 'products.*']),
                        ])>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="{{ route('home') }}"><img src="{{ asset('assets/client/images/icons/logo-01.png') }}"
                    alt="IMG-LOGO"></a>
        </div>
