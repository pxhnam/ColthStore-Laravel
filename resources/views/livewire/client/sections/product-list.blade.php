    ...
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52" wire:ignore>
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 @if (empty($category)) how-active1 @endif"
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <div class="bor8 dis-flex p-l-15">
                    ...
                    <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search-product"
                        placeholder="Search" autocomplete="off" wire:model.live='search' wire:change='resetPage()'>
                </div>
            </div>
        ...
        <div class="row isotope-grid">
            ...
            <x-client.blocks.product id='{{ $product->id }}'
