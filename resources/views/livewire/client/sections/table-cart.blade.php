                        ...
                        <table class="table-shopping-cart">
                            ...
                            @foreach ($carts as $cart)
                                <tr class="table_row">
                                    ...
                                    <td class="column-2">{{ $cart->variant->product->name }}</td>
                                    <td class="column-3">{{ NumberFormat::VND($cart->variant->cost) }}</td>
                                    <td class="column-4">
                            ...
                            {{-- <tr class="table_row">
                                <td class="column-1">
                                    <div class="how-itemcart1">
                                        <img src="{{ asset('assets/client/images/item-cart-04.jpg') }}" alt="IMG">
                                    </div>
                                </td>
                            ...
                            <tr class="table_row">
                                <td class="column-1">
                                    <div class="how-itemcart1">
                                        <img src="{{ asset('assets/client/images/item-cart-05.jpg') }}" alt="IMG">
                                    </div>
                                </td>
